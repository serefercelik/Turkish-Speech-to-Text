...
You can download and create `manifest.jsonl` from some of the common publically available [speech dataset in Turkish and some other languages](https://github.com/Rumeysakeskin/speech-datasets-for-ASR) for ASR.
